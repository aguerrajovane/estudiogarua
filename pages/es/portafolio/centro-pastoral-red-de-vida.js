    ...
    <Layout> 
     ...
     <main className="flex flex-col w-full max-w-6xl mx-auto justify-between lg:pl-28 sm: py-8 pl-4 pr-4">
        ...
        <header className="relative h-screen my-0 py-0">
          <h1 className="absolute bottom-60 text-5xl md:text-6xl font-bold leading-snug mb-4 hyphens-auto fade-in-up" lang="es">Centro Pastoral Red de Vida</h1>
        </header>
        {/* Contenido */}
